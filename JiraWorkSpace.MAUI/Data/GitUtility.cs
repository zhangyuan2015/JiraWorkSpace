    ...
    public class GitUtility
    {
        ...
        public void ExcuteGitCommandReceived(string strCommnad)
        {
            ...
            try
            {
                ...
                p.Exited += delegate (object sender, EventArgs e) { Process_Exited(sender, e, strCommnad); };
        ...
        private void Process_Exited(object sender, EventArgs e, string strCommnad)
        {
            DataReceived($"{DateTime.Now.ToShortTimeString()} - 执行完毕 - {strCommnad}{Environment.NewLine}");
        }
